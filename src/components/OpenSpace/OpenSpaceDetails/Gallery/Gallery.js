...
class Gallary extends Component {
  ...
  fetchMaps = () => {
    Axios.get(`${process.env.BASE_URL_API}/gallery/?id=${localStorage.getItem("OpenspaceID")}&type=map`).then(response => {
  ...
  fetchImages = () => {
    ...
    Axios.get(`${process.env.BASE_URL_API}/gallery/?id=${localStorage.getItem("OpenspaceID")}&type=image`).then(response => {
      this.setState({
